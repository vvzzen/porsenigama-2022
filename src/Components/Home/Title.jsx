    ...
    return (
        <div className = 'z-30 h-full relative md:flex items-center md:items-stretch md:justify-start md:content-end' >
            ...
            <div className = 'md:w-45c cursor-default'>
                <div className = 'flex md:items-stretch justify-center md:ml-28 md:justify-start md:content-end text-5xl md:text-onetwenty md:mt-32 text-biru font-nuku' style = {{ "-webkit-text-stroke": "1.5px #F8BF0D" }}> 
                    <div style = {{
                            "text-shadow": [
                            "6px 6px 0 #F8BF0D",
                            "6px 2px 0 #F8BF0D",
