...
const Title = () => {
    return (
        <div className = 'z-30 h-full relative flex items-stretch justify-center md:justify-start content-end' >
            <div className = 'h-2'></div>
            <div className = 'w-45c cursor-default'>
                ...
                <p className = 'font-sansPro text-left md:ml-28 md:mr-8 md:mt-8'>Pekan Olahraga dan Seni Universitas Gadjah Mada (Porsenigama) merupakan suatu ajang kejuaraan olahraga dan seni yang dilaksanakan 
            ...
            <img src='images/Title/Group 42.png' alt="Mountain" className = 'z-40 absolute mt-12'/>
        </div>
    )
}
